...
else
{
      ...
      $table3="immigrant_data_update";
      $query="SELECT * from $table where id=$id";
      $query3="SELECT * from $table3 where bid=$id";
      $q=$con->query($query);
      ...
      while($a=mysqli_fetch_array($q,MYSQLI_BOTH))
                {
                    ...
                    $q3=$con->query($query3);
                    $b=mysqli_fetch_array($q3,MYSQLI_BOTH);
                    ...
                    echo "<input type='text'   value=".$b['house']." name='thouse' ><br>";
                    echo "<label> Town  :  &nbsp;&nbsp;</label>";
                    echo "<input type='text'   value=".$b['town']." name='ttown' >&nbsp;&nbsp;&nbsp;&nbsp;";
                    echo "<label> District  :  &nbsp;&nbsp;</label>";
                    echo "<input type='text'   value=".$b['dist']." name='tdist' ><br>";
                    echo "<label> State  :  &nbsp;&nbsp;</label>";
                    echo "<input type='text'   value=".$b['state']." name='tstate' >&nbsp;&nbsp;&nbsp;&nbsp;";
                    echo "<label> Skill  :  &nbsp;&nbsp;</label>";

                  

                    echo "<input type='text'   value=".$b['skill']." name='tskill' ><br>";
                    echo "<label> Permanent Address  :  &nbsp;&nbsp;</label>";
                    echo "<input type='text'   value=".$a['curradr']." name='tcurradr' >&nbsp;&nbsp;&nbsp;&nbsp;";
                    echo "<label> Mobile No  :  &nbsp;&nbsp;</label>";
                    echo "<input type='tel'   value=".$b['mob']." name='tmob' ><br>";
                    echo "<label> Arrival Date  :  &nbsp;&nbsp;</label>";
                    echo "<input type='date'   value=".$a['arrival']." name='tarrival' >&nbsp;&nbsp;&nbsp;&nbsp;";
                    echo "<label> Cases  :  &nbsp;&nbsp;</label>";
                    echo "<input type='text'   value=".$b['cases']." name='tcases' ><br>";
                    $aadhar=$a['aadhar'];
                    ...
                    echo "<input type='text'   value='".$b['edu']."' name='tedu' ><br>";
                    ...
                    echo "<label> Educational Qualification  :  &nbsp;&nbsp;</label>";
                    echo "<input type='text'   value=".$b['edu']." name='tedu' >&nbsp;&nbsp;&nbsp;&nbsp;";
                    echo "<label> Agent Name  :  &nbsp;&nbsp;</label>";
