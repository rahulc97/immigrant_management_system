...
<html>
    <head>
        ...
        <body bgcolor=f3f3f3>
            ...
            <div  class="form">
			<u style="color:#962390"><h2 align='center' style="color: #962390; font-weight: bold; "><br><br>New Updation Requests</h2></u>
...
$con= new mysqli($dbhost,$dbusername,$dbpassword,$dbname);
      ...
      if($con)
	  {
        ...
        $table1="immigrant_data";
        $query="SELECT * from $table where flag=-1";
		$q=$con->query($query);
		// echo base64_decode($q["image"]);  
		//   echo "<table border='10' align='center' cellpadding='7'><tr><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Photo&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mobile No&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Start Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reason&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Allow/Deny&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>";
		  while($b=mysqli_fetch_array($q,MYSQLI_BOTH))
                {
					// $content = mysql_real_escape_string($a['img']); 
				...
				$query1="SELECT * from $table1 where id=$b[1]";
				$q1=$con->query($query1);
				$a=mysqli_fetch_array($q1,MYSQLI_BOTH);
				...
				<form  action='expandupdate.php' method='POST'>
		...
		//   echo "<h3 align='center'><br>Update Requests</h3></table>";
